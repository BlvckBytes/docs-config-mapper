...
const config: Config = {
  ...
  baseUrl: '/docs-config-mapper/',

  // GitHub pages deployment config.
  // If you aren't using GitHub pages, you don't need these.
  organizationName: 'blvckbytes', // Usually your GitHub org/user name.
  projectName: 'docs-config-mapper', // Usually your repo name.
  ...
  themeConfig: {
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://github.com/BlvckBytes/BukkitEvaluable',
          label: 'GitHub',
          position: 'right',
        },
      ],
